...
REMOVE_PATHS = [
    ...
    "{% if cookiecutter.jupyter_notebook_project == 'yes' %} {{cookiecutter.package_name}}/main.py {% endif %}",
    "{% if cookiecutter.jupyter_notebook_project == 'yes' %} tests/test_main.py {% endif %}",
