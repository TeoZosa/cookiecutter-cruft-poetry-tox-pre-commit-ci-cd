...
.. _Source Code: {{ cookiecutter.project_repository_url }}
.. _Documentation: {{cookiecutter.documentation_url}}
.. _Issue Tracker: {{ cookiecutter.project_repository_url }}/issues
...
.. _pull request: {{ cookiecutter.project_repository_url }}/pulls
.. github-only
