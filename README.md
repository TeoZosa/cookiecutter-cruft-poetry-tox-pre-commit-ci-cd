...
- Project-specific [Docker](https://www.docker.com/) image
  Dockerfile[^*] with production dependencies for a
...
[^†]: Jupyter notebook compatibility via [nbQA](https://github.com/nbQA-dev/nbQA)
...
[^§]: Custom setup steps in Sphinx configuration file for Read the Docs compatibility (see: [conf.py:117-139]({{cookiecutter.project_slug}}/docs/source/conf.py#L117-L139))
